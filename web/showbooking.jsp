<%@page import="eco.beans.EmpRequest,java.util.List,org.hibernate.Criteria,org.hibernate.Session,org.hibernate.SessionFactory,org.hibernate.Transaction,org.hibernate.cfg.Configuration"%>
           ...
           <br><br><br><br><br><br>
                <table  width="100%"  align="center" cellspacing="30px" style="margin-top: -50px; color: white">
                    ...
                    <%
                        ...
                        Criteria crit=session1.createCriteria(EmpRequest.class);
                        List<EmpRequest> data=crit.list();
                    for(EmpRequest employee: data)
                    {
                    %><tr>
                        <td><%=employee.getId()%></td>
                        <td><%=employee.getCabtype()%></td>
                        <td><%=employee.getSharingchoice()%></td>
                        <td><%=employee.getEmpdestination()%></td>
