...
<html>
    <style>
        body
        {
          background-image:url('images2/authsetting.gif'); 
...
@keyframes bankease2
{
    ...
    <body>
        ...
        <div  class="option">
            ...
            <struts:form action="authpasscode.action" cssStyle="margin-top:50px;margin-left:-50px;text-color:#4c9e92">
                
                <table align="center" cellpadding="10px">
                    
                <tr>
         
                    <td><struts:textfield label="Id" name="id" cssStyle="width:200px;height:25px;border-radius:5px;"/></td>
                </tr>    
                
                <tr><td> <struts:password label="Password" name="password" cssStyle="width:200px;height:25px;border-radius:5px;"/> </td></tr>  
