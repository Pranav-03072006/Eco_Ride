...
<html>
    <style>
        body
        {
          background-image:url('images2/eco10.jpg'); 
    ...
    <body>
        ...
        <div class="data">
            <h2>
                <marquee style="color:white;width: 999px;margin-left:-250px">Swift Rides, Seamless Journeys and Save the Environment | Anytime, Anywhere</marquee>
            </h2>
            
            <p style="font-size:39px;font-family: sans-serif;color: white;width: 750px;margin-left:100px">
                Ditch the traffic. Cut the carbon. EcoRide makes commuting smarter, greener, and way less boring.
