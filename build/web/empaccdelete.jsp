...
<html>
    <style>
        body
        {
          background-image:url('images2/accdelete2.gif'); 
    ...
    <body>
        ...
        <div  class="option">
            ...
            <struts:form action="accountdeletecode.action" cssStyle="margin-top:200px;margin-left:-50px;text-color:#4c9e92">
                ...
                <tr align="center">
                    <struts:submit  label="submit" value="Delete" theme="simple"  cssStyle="width:300px;height:30px;margin-top:30px;margin-left:200px;color: #4c9e92;background-color: black;border-radius:10px;"/>
